...
<body>
   ...
   <tr>
       <td colspan="2" align="center"> <input type="submit" class="myButton" name="submit" value="Update"></td>
   </tr>
...
// Check if image file is a actual image or fake image
   ...
   $query ="UPDATE product SET category_id='$category_id',sub_category_name='$subcat', name='$product_name', description='$product_description', price='$price', stock = '$stock', in_sale ='$in_sale', image='$image', discount='$discount' WHERE id = $id";
