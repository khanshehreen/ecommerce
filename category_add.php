...
<?php
 include ('utilitis/config.php'); 
  ...
  if(isset($_POST['submit'])){
   ...
   $query ="insert into category(name,sub_category_name,description,image,page_title,page_keywords,page_description) values('$category_name','$sub_category_name','$category_description','$image','$page_title','$page_keywords','$page_description')";
